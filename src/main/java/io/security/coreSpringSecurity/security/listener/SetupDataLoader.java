...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void setupSecurityResources() {
        ...
        createResourceIfNotFound("io.security.coreSpringSecurity.aopsecurity.method.AopMethodService.methodSecured", "", roles1, "method");
    ...
    private void setupAccessIpData() {
        ...
        byIpAddress = accessIpRepository.findByIpAddress("0:0:0:0:0:0:0:1");
        if (byIpAddress == null) {
            AccessIp accessIp = AccessIp.builder()
